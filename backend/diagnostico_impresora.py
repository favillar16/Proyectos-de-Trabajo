...
Script de diagnóstico y prueba de la impresora térmica FTX FTXP-80W.
...
Qué hace:
  ...
  2. Verifica si la impresora configurada existe
  3. Imprime un ticket de prueba
  4. Muestra el ticket en texto plano en la consola
"""
import os
import sys
...
if __name__ == '__main__':
    separador()
    print('  Diagnóstico de impresora térmica — FTX FTXP-80W')
    separador()
